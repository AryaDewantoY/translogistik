...
<th width="12%" bgcolor="#999999"><span class="style3">Pengiriman</span></th>
...
<?php
$sql = mysql_query("select * from pemesanan where status='Setuju' order by id_pemesanan desc limit $posisi, $batas ");
$no=1;
...
<a  href='?module=proses_pengiriman&id=<?echo$r[id_pemesanan];?>'>
<button class='btn btn-warning'>Proses</button></a></td></tr>
<?
$no++;
}
?>
